...
- Takes the pull request out of draft so it can be reviewed. The discussion thread stays open — through review and on through implementation, until the plan is done or abandoned.
