...
- Fills in the metadata header (authors, dates, `Status: DRAFT`, target repositories).
...
- `/draft-plan`: Agent prompts you for the goal, scope, and target repositories, then scaffolds the branch, document, and draft PR.
